	...
	return []Route{
		{
			...
			http.MethodPost,
			"/api/v1/timers",
			handleFunctions.DefaultAPI.CreateTimer,
		},
		{
			"DeleteTimer",
			http.MethodDelete,
			"/api/v1/timers/:groupId/:timerId",
			handleFunctions.DefaultAPI.DeleteTimer,
		},
		{
			"GetTimer",
			http.MethodGet,
			"/api/v1/timers/:groupId/:timerId",
			handleFunctions.DefaultAPI.GetTimer,
		},
		{
			"UpdateTimer",
			http.MethodPut,
			"/api/v1/timers/:groupId/:timerId",
			handleFunctions.DefaultAPI.UpdateTimer,
		},
	}
}
